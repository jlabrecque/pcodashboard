class CreateCrons < ActiveRecord::Migration[5.0]
  ...
  prime = Cron.create(:job_name => "ServicesLoad", :script_name => "lib/service-dbload.rb", :parameters => "", :description => "Nightly incremently Service dB sync",:dow => "", :recurring => "Daily",:hour => 3,:minute => 00,:enabled => FALSE)
